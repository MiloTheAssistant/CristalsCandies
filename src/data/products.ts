...
export const products: Product[] = [
  {
    ...
    image: "/products/honey-amber-drops.jpg",
    images: ["/products/honey-amber-drops.jpg"],
    inStock: true,
    bestseller: true,
  ...
  },
  {
    ...
    image: "/products/lavender-twilight-melts.jpg",
    images: ["/products/lavender-twilight-melts.jpg"],
    inStock: true,
    bestseller: true,
  ...
  },
  {
    ...
    image: "/products/cinnamon-heart-warms.jpg",
    images: ["/products/cinnamon-heart-warms.jpg"],
    inStock: true,
  ...
  },
  {
    ...
    image: "/products/rose-garden-petals.jpg",
    images: ["/products/rose-garden-petals.jpg"],
    inStock: true,
  ...
  },
  {
    ...
    image: "/products/spiced-cider-jewels.jpg",
    images: ["/products/spiced-cider-jewels.jpg"],
    inStock: true,
    limitedEdition: true,
  ...
  },
  {
    ...
    image: "/products/winterberry-frost.jpg",
    images: ["/products/winterberry-frost.jpg"],
    inStock: true,
    limitedEdition: true,
  ...
  },
  {
    ...
    image: "/products/classic-assortment-box.jpg",
    images: ["/products/classic-assortment-box.jpg"],
    inStock: true,
    bestseller: true,
  ...
  },
  {
    ...
    image: "/products/sweet-surprise-box.jpg",
    images: ["/products/sweet-surprise-box.jpg"],
    inStock: true,
  ...
  },
  {
    ...
    image: "/products/custom-candy-creation.jpg",
    images: ["/products/custom-candy-creation.jpg"],
    inStock: true,
